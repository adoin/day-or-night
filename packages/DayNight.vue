<template>
  <span
    :class="`sw-button ${modelValue ? 'is-night' : ''} ${props.className}`"
    v-bind="restProps"
...
<style lang="scss">
  ...
  .bg0 {
    ...
    top: 0;
    left: 0;
    //background: linear-gradient(left, #9db8f7 0%, #4f77ce 100%);
    background: linear-gradient(to right, #9db8f7 0%, #4f77ce 100%);
    opacity: 100%;

    &.bg2 {
      //background: linear-gradient(left, #043789 30%, #020914 100%);
